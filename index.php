         ...
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                     ...
                     <p class="about_text">Gorakhpur coffee primarily serves coffee of various types, notably espresso, latte, and cappuccino. Some coffeehouses may serve cold drinks, such as iced coffee and iced tea, as well as other non-caffeinated beverages. In continental Europe, cafés serve alcoholic drinks.</p>
               ...
               <div class="about_taital">Login</div>
               <form action="form1.php" name="form1" method="POST">
                  <div class="mail_section">
                     <div class="email_text">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="UserID" name="userId">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="send_btn" style="position:relative;left:-20%">
                           <input type="submit" name="submit" value="login" class="main_bt send_btn" style="padding:10px; background-color:orange;position:relative;left:50%">
                       <a href="register.php" style="color:white; font-size:18px;position:relative;left:50%">Registration</a>
               </div>
</form>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <p class="client_text">Today I stopped in Cup of dreams and was not disappointed. It’s very clean, it seems like it would be a great environment bring your laptop and work. I got the mocha cappuccino with whipped cream and it is so smooth and creamy. I will definitely be going back to try the Boba tea.</p>
               </div>
            </div>
         </div>
                   ...
                   <div class="row">
                      <div class="col-md-12">
                         <div class="testimonial_section_2">
                            ...
                            <p class="customer_text">From the moment I walked in, I appreciated how relaxed the interior is. Really nice atmosphere, vibe, and staff. My coffee was fantastic and I will be back every week to enjoy! Definitely trying the boba next time!!</p>
                         </div>
                      </div>
                   </div>
                </div>
